  ...
  render() {
    const alertClass =
      this.state.message === null
        ? "alert alert-dismissible alert-info  displayNone"
        : "alert alert-dismissible alert-info  displayBlock";
    ...
    return (
      <div>
        <div className="mb-2">
          ...
          <button
            className="btn seaLightGreen ml-2"
            onClick={() => {
              this.hit();
            }}
          >
        ...
        {!this.state.currentBet ? (
          <div className="input-bet">
            ...
            <button
              className="btn seaLightGreen ml-2 mt-2 mb-4"
              onClick={() => {
                this.placeBet();
              }}
            >
        ...
        <div className="row" style={{ width: "800px" }}>
          <div className="col-lg-6">
            <p className="cursive">Your Hand ({this.state.player.count})</p>
          ...
          <div className="col-lg-6">
            <p className="cursive">Dealer's Hand ({this.state.dealer.count})</p>
            <table className="cards">
              <tr>

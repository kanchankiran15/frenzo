...
class Register extends Component {
  ...
  render() {
    ...
    return (
      <Card className="col-md-4 rmtml" style={{ padding: 0 }}>
        <CardHeader className="seaLightGreen">
          <h2 style={{ color: "seashell" }}>Sign Up</h2>
        </CardHeader>
        <CardBody>
          <form name="form" onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <button className="btn btn-primary seaLightGreen">
                Register
              </button>
              {registering && (
                <img
